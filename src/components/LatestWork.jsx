...
<ol class="border-s-2 border-[#bebae0] ml-12">
  {/* <!--First item--> */}
  <li>
    <div class="flex-start md:flex">
      <div
        class="-ms-[16px] flex h-[35px] w-[35px] items-center justify-center rounded-full bg-[#bebae0] text-info-700">
        <svg
      ...
      <div
      class="mb-10 ms-6 block max-w-md rounded-lg bg-[#160a33] p-6 shadow-md shadow-black/5 ">
