      ...
      <div class="blogs-content ml-5 mr-7">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-4 text-base text-white leading-relaxed text-gray-600">
            In today's competitive landscape, your business needs more than just
            a website or a logo.
          </p>
        </div>
        ...
        <div class="blogs">
          <div class="blog" style={{ background: "#160a33" }}>
            <img
              src="https://propelrr.com/wp-content/uploads/2023/02/answering-what-is-ux-ui-design-and-a-blueprint-for-projects.webp"
              alt=""
            ></img>
            <div class="blog-text">
