		...
		<div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
			<div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-[#160a33]">
				<p className="relative px-6 py-1 text-lg italic text-center text-[#bebae0]">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#bebae0" className="w-8 h-8 dark:text-violet-600">
					...
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#bebae0" className="absolute right-0 w-8 h-8 ">
